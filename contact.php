...
<div class="container" style="margin-top: 40px; margin-bottom: 60px;">
    ...
    <div style="margin-top: 60px;">
        ...
        <div style="background: #f3f4f6; height: 400px; border-radius: 10px; display: flex; align-items: center; justify-content: center;">
            <p style="color: #6b7280; font-size: 18px;">🗺️ Google Map энд харагдана</p>
            <!-- Google Maps iframe нэмэх бол: -->
            <!-- <iframe src="..." width="100%" height="400" style="border:0; border-radius: 10px;" allowfullscreen="" loading="lazy"></iframe> -->
        </div>
    </div>
